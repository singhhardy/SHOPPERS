...
const { GetAllUsers, DeleteUserById, GetUserProfile, EditUserProfile, ChangePassword, AddNewAddress, GetProfile, EditProfile, GetUserAddresses, DeleteAddress, updateDefaultAddress, addToNewsLetter } = require('../controllers/userController');
...
router.route('/subscribe-newsletter').post(addToNewsLetter)
